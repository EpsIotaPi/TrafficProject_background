...
from m_classify_modules import BiLstmCRF
...
def evaluate(sess, model, test_loader, hp):
    ...
    ckpt = tf.train.get_checkpoint_state(hp.checkpoint_m_classify_dir)
...
with tf.Session() as sess:
    ...
    for epoch in range(hp.epochs):
        ...
        model.saver.save(sess, hp.checkpoint_path_m_classify)
